...
class Siswa extends React.Component {
    constructor(){
        ...
        this.state = {
            siswa : [
                {nis: "100", nama: "Nindy ", alamat: "Jl Imam Bonjol 206, Jawa Timur"},
                {nis: "101", nama: "Citra ", alamat: "Jl Jatibaru Raya 77, Sumatra"},
                {nis: "102", nama: "Amalyani ", alamat: "Jl Mpu Tantular 1 B, Jawa Barat"},
            ],
            nis: "",
            nama: "",
            alamat: "",
